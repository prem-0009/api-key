...
// const readline = require("readline");////not using currently
...
// const rl = readline.createInterface({
  ...
  let urlByKeyWord =  `https://newsapi.org/v2/everything?q=${word1}&from=2020-09-25&to=${currentDate}&sortBy=popularity&apiKey=${key}` ;///not using currently
  ...
  let repeat = (choosenUrl) => {//////////////////call-back function
    fetch(choosenUrl)
    .then((response)=>{
      console.clear()///clears the message
